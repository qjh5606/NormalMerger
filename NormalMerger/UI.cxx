...
#define IMPORT_FROM_BUTTON2 1006
#define IMPORT_FROM_EDITBOX2 1007
...
char gszInputFile2[_MAX_PATH];            // File name to import
...
void GetInputFileName2(HWND hWndParent);
                       ...
                       )
{
    ...
    ZeroMemory(gszInputFile2, sizeof(gszInputFile2));
                         ...
                         )
{
    ...
    case WM_COMMAND:
		...
		case IMPORT_FROM_BUTTON2:
			GetInputFileName2(hWnd);
			break;
                      ...
                      )
{
    ...
    CreateWindowEx( 
        ...
        "Lighting FBX",  // LPCTSTR lpWindowName / control caption
    ...
    CreateWindowEx(
        0,                          // DWORD dwExStyle,
        "BUTTON",                   // LPCTSTR lpClassName
        "Outline FBX",   // LPCTSTR lpWindowName / control caption
        dwStyle,                    // DWORD dwStyle
        10,                         // int x
        50,                         // int y
        130,                        // int nWidth
        30,                         // int nHeight    
        hWndParent,                 // HWND hWndParent
        (HMENU)IMPORT_FROM_BUTTON2, // HMENU hMenu or control's ID for WM_COMMAND 
        hInst,                      // HINSTANCE hInstance
        NULL                        // LPVOID lpParam
    );
	...
	CreateWindowEx(
		...
		20,                             // int nHeight    
		hWndParent,                     // HWND hWndParent
		(HMENU)IMPORT_FROM_EDITBOX2,    // HMENU hMenu or control's ID for WM_COMMAND 
		hInst,                          // HINSTANCE hInstance
		NULL                            // LPVOID lpParam
	);
...
)
{
	...
	// show the file name selected
	SetWindowText(GetDlgItem(hWndParent, IMPORT_FROM_EDITBOX2), szFile);

	// Keep a copy of the file name
	FBXSDK_strcpy(gszInputFile2, _MAX_PATH, szFile);
}
                         ...
                         )
{
	...
	if (strlen(gszInputFile2) == 0)
	{
		UI_Printf("Error: No import file name 2 selected.");
		return;
	}
    ...
    GetWindowText( GetDlgItem(hWndParent, IMPORT_FROM_EDITBOX2), gszInputFile2, _MAX_PATH);
	...
	// check if the file to import still exist
	if (FbxFileUtils::Exist(gszInputFile2) == false)
	{
		UI_Printf("Error: Import file 2 not found.");
		return;
	}
    ...
    ImportExport(gszInputFile, gszInputFile2, gszOutputFile, gWriteFileFormat);
